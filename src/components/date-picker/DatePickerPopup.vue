<template>
  <div class="date-picker-popup">
    <div class="date-picker-popup__switch">
      <div class="date-picker-popup__previous-button-container">
        <button
          class="date-picker-popup__skip-button date-picker-popup__one-year-ago"
          :title="oneYearAgoCalendar.title"
          @click="onMoveCalendar(oneYearAgoCalendar)"
        />

        <button
          class="date-picker-popup__button date-picker-popup__previous"
          :title="previousCalendar.title"
          @click="onMoveCalendar(calendars[1])"
        />
      </div>
      <div class="date-picker-popup__next-button-container">
        <button
          class="date-picker-popup__button date-picker-popup__next"
          :title="nextCalendar.title"
          @click="onMoveCalendar(nextCalendar)"
        />

        <button
          class="date-picker-popup__skip-button date-picker-popup__one-year-later"
